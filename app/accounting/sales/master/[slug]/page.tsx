...
const CREATOR_ROLES: TitleCreator['role'][] = ['글/그림', '글', '그림', '원작'];
...
const ROLE_COLORS: Record<string, string> = {
  '글/그림': 'bg-indigo-50 text-indigo-600 dark:bg-indigo-900/20 dark:text-indigo-400',
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <button onClick={() => setDraft({ ...draft, creators: [...draft.creators, { role: '글', name: '' }] })} className="text-xs text-cyan-500 hover:text-cyan-600 flex items-center gap-1"><Plus className="h-3 w-3" /> 작가 추가</button>
                </div>
              </div>
            </div>
