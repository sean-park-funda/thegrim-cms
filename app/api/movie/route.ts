...
// GET: /api/movie - 모든 프로젝트 목록 조회
export async function GET(request: NextRequest) {
  console.log('[movie][GET] 프로젝트 목록 조회');
...
// POST: /api/movie - 새 프로젝트 생성
export async function POST(request: NextRequest) {
  console.log('[movie][POST] 새 프로젝트 생성');
  ...
  if (error) {
    console.error('[movie][POST] 생성 실패:', error);
